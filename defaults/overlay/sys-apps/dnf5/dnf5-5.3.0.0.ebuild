...
# From ::guru at b23748630f89, only this comment added.  ::gentoo has no
# dnf; the fedora rootfs provider installs fedora-packages.txt with this.
...
SLOT="0"
KEYWORDS="~amd64"
IUSE="appstream manifest nls python systemd test"
...
RDEPEND="
	...
	manifest? ( dev-libs/libpkgmanifest )
	python? ( ${PYTHON_DEPS} )
...
src_configure() {
	local mycmakeargs=(
		...
		-DWITH_PLUGIN_MANIFEST=$(usex manifest)
