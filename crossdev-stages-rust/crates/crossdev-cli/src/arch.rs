//! Architecture parsing and alias handling
//!
//! This module provides functions to parse and normalize architecture names,
//! including support for common aliases and shorthands.
